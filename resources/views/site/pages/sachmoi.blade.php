                                ...
                                <div class="limiter hidden-xs">
                                    ...
                                    <div class="limiter-inner">
                                        <select id="select_paginate" class="form-control input-sm">
                                           @for($page=1;$page<=$sach_moi->lastPage();$page++)
                                            <option src="#" @if($sach_moi->currentPage()==$page) selected="selected" @endif>
                                                    {{$page}}
                                            </option>
                                           @endfor
                                        </select> 
               ...
               //=========================XỬ LÝ PHÂN TRANG==============
                $("#select_paginate").change(function(){
                     //  alert($( "#select_paginate option:selected" ).val());
                        //alert("ok");
                    var url="sach-moi";  // luc nay url se la : http://localhost:8080/laravel-sach/sach-moi
